""""
判定用户意图，看他是让我回答具体某个美食制作还是推荐美食（第二层滤网）
"""
...
def whatDoYouMean(user_query,model,tokenizer):
   ...
   # 核心修正：精准关键词库
    ...
    # 1. 制作信号（不变）
    make_signals = {'how to', 'make', 'cook', 'process', 'prepare', 'steps', 'way to', 'explain how', 'show me the steps', 'what steps', 'prep' ,' egg fried rice'}
    # 2. 推荐信号（不变）
    recommend_signals = {
